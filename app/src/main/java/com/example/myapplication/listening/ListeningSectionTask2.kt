...
class ListeningSectionTask2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        backListeningSection = findViewById(R.id.back_listening_section_button_task_2)
        mediaPlayer = MediaPlayer.create(this, R.raw.listening_task_2)
        btnPlay = findViewById(R.id.listening_section_task_2_play)
        btnPause = findViewById(R.id.listening_section_task_2_pause)
        btnStop = findViewById(R.id.listening_section_task_2_stop)
        btnShowAnswers = findViewById(R.id.listening_task_2_check_button)
        textTask2Answers = findViewById(R.id.listening_section_answers_textView_task_2)
        mediaPlayerCardView = findViewById(R.id.listening_section_media_player_task_2)
        ...
        btnShowAnswers.setOnClickListener {
            if (isButtonClicked) {
                setInactiveColorElement(btnShowAnswers)
                textTask2Answers.visibility = View.GONE
            } else {
                setActiveColorElement(btnShowAnswers)
                textTask2Answers.visibility = View.VISIBLE
            }
