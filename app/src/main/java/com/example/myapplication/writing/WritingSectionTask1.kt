...
class WritingSectionTask1 : AppCompatActivity() {

    private lateinit var backToWritingSection: ImageButton
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_writing_section_task1)

        backToWritingSection = findViewById(R.id.back_writing_section_button_t1)
